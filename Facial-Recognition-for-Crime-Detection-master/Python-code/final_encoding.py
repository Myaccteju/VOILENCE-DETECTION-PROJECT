...
data = pickle.loads(open("C:/Users/tejas/Downloads/Facial-Recognition-for-Crime-Detection-master/Facial-Recognition-for-Crime-Detection-master/Python-code/enc.picke", "rb").read())
data=np.array(data)
